...
Public Class report
    ...
    Private Sub PROFORMESTYP()
        ...
        Try
            ...
            If oldPartida = 0 Then ' NEA PARTIDA
                SQLQuery = "INSERT INTO PARTIDES (PARTIDA,HME,KOD,TIMOLOGIA,TEMAXIA,YPOL,N1) VALUES(" + Str(MP) + ",'" + HM + "','" + kodPROION + "','" + TIMOLS + "'," + TEMAX + "," + TEMAX + "," + Str(CHECKID) + ")"
            Else
                SQLQuery = "UPDATE PARTIDES SET YPOL=ISNULL(YPOL, 0)+" + TEMAX + ", TEMAXIA=ISNULL(TEMAXIA, 0)+" + TEMAX + " WHERE ID=" + Str(oldPartida)
            End If
    ...
    Private Sub EKTYPOSI()
        ...
        Try
            Dim sqlCon As New OleDbConnection(gConnect)
            If oldPartida = 0 Then ' NEA PARTIDA
                SQLQuery22 = "INSERT INTO PARTIDES (PARTIDA,HME,KOD,TIMOLOGIA,TEMAXIA,YPOL,N1) VALUES(" + Str(MP) + ",'" + HM + "','" + kodPROION + "','" + TIMOLS + "'," + TEMAX + "," + TEMAX + "," + Str(CHECKID) + ")"
            Else
                SQLQuery22 = "UPDATE PARTIDES SET YPOL=ISNULL(YPOL, 0)+" + TEMAX + ", TEMAXIA=ISNULL(TEMAXIA, 0)+" + TEMAX + " WHERE ID=" + Str(oldPartida)
            End If
