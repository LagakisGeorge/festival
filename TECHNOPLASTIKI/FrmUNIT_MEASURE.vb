...
Public Class ergates
    ...
    Private Sub GridView1_DataError1(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles GridView1.DataError
...
0:
    ...
    Private Sub deleteTIMPOL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deleteTIMPOL.Click
        ...
        ' Dim id As Integer
        Dim mks(50) As String
        Dim mkods(50) As String
        Dim nn As Integer = 0
        For Each selectedItem As DataGridViewRow In GridView1.SelectedRows
            nn = nn + 1
            mks(nn) = selectedItem.Cells(STHLHTOY_ID).Value.ToString
            mkods(nn) = selectedItem.Cells(1).Value.ToString
        Next selectedItem
        ...
        Dim ans2 As Integer
        ans2 = MsgBox("Να διαγραφεί το τιμολόγιο ", MsgBoxStyle.YesNo)
        ...
        For knn = 1 To nn
            ...
            ' ο κωδικος του προιοντος που διαλεξα
            Dim mk As String = mks(knn) ' GridView1.CurrentRow.Cells(STHLHTOY_ID).Value.ToString
            Dim mkod As String = mkods(knn) 'GridView1.CurrentRow.Cells(1).Value.ToString
    ...
    Private Sub Button3_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDEPANEKTYPOSI.Click
        ...
        Dim lproel = InStr(Label2.Text, "Προέλ")
        If lproel < 9 Then
            lproel = 9
        End If
        ...
        '6-3-21 EGINE REM KAI ANTIKATASTATHIKE APO TIS 3 EPOMENES SEIRES TELBARCODE = "'0205200000" + Mid(mProion + Space(6), 1, 6) + "300" + Mid(Str(100000 + R(0)("TEMAX")), 3, 5) + "10000" + Mid(LTrim(R(0)("PART").ToString), 1, 7)


       
        Dim chkdig As String = findCheckDigit("521301114" + Mid(mProion + Space(6), 3, 6))
        TELBARCODE = "'02521301114" + Mid(mProion + Space(6), 3, 4) + chkdig + "300"
        TELBARCODE = TELBARCODE + Mid(Str(100000 + R(0)("TEMAX")), 3, 5) + "100" + Mid(LTrim(R(0)("PART").ToString), 1, 7)  '  Mid(LTrim(Str(MP)), 1, 7)
        ...
        mnow = xlWorkSheet.Cells(8, 4).value

        'display the cells value B2
        '    MsgBox(xlWorkSheet.Cells(6, 1).value)
        'edit the cell with new value
        xlWorkSheet.Cells(7, 2) = Mid(Label2.Text, 8, lproel - 8) '      Mid(Label2.Text + Space(40), 8, 40) ' R(0)("ONO").ToString  '"" 'onomaProion
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        FrmAddEidos.MON.Text = GridView1.CurrentRow.Cells(5).Value.ToString
        FrmAddEidos.BAROS.Text = GridView1.CurrentRow.Cells(3).Value.ToString
        FrmAddEidos.PIECESPERPALLET.Text = Replace(GridView1.CurrentRow.Cells(6).Value.ToString, ",", ".")
